...
import { AddMergeRequestDiffCommentSchema, CreateBranchSchema, CreateIssueLinkSchema, CreateIssueSchema, CreateLabelSchema, CreateMergeRequestSchema, CreateNoteSchema, CreateOrUpdateFileSchema, CreateRepositorySchema, DeleteIssueLinkSchema, DeleteIssueSchema, DeleteLabelSchema, ForkRepositorySchema, GetFileContentsSchema, GetIssueLinkSchema, GetIssueSchema, GetLabelSchema, GetMergeRequestCommentsSchema, GetMergeRequestDiffsSchema, GetMergeRequestSchema, GetNamespaceSchema, GetProjectSchema, GitLabCommitSchema, GitLabContentSchema, GitLabCreateUpdateFileResponseSchema, GitLabDiscussionNoteSchema, GitLabDiscussionSchema, GitLabForkSchema, GitLabIssueLinkSchema, GitLabIssueSchema, GitLabIssueWithLinkDetailsSchema, GitLabMergeRequestDiffSchema, GitLabMergeRequestSchema, GitLabNamespaceExistsResponseSchema, GitLabNamespaceSchema, GitLabProjectSchema, GitLabReferenceSchema, GitLabRepositorySchema, GitLabSearchResponseSchema, GitLabTreeSchema, ListGroupProjectsSchema, ListIssueLinksSchema, ListIssuesSchema, ListLabelsSchema, ListMergeRequestDiscussionsSchema, ListNamespacesSchema, ListOpenMergeRequestsSchema, ListProjectsSchema, PushFilesSchema, SearchRepositoriesSchema, UpdateIssueSchema, UpdateLabelSchema, UpdateMergeRequestNoteSchema, UpdateMergeRequestSchema, VerifyNamespaceSchema } from './schema.js';
/**
 ...
 */
export async function handleGitLabError(response) {
 ...
 */
export async function getDefaultBranchRef(projectId) {
 ...
 */
export async function getFileContents(projectId, filePath, ref) {
 ...
 */
export async function deleteIssue(projectId, issueIid) {
    const url = new URL(`${GITLAB_API_URL}/projects/${encodeURIComponent(projectId)}/issues/${issueIid}`);
    try {
 ...
 */
export async function listIssueLinks(projectId, issueIid) {
 ...
 */
export async function getIssueLink(projectId, issueIid, issueLinkId) {
 ...
 */
export async function createIssueLink(projectId, issueIid, targetProjectId, targetIssueIid, linkType = 'relates_to') {
    const url = new URL(`${GITLAB_API_URL}/projects/${encodeURIComponent(projectId)}/issues/${issueIid}/links`);
    try {
        const response = await axios.post(url.toString(), {
 ...
 * @returns {Promise<void>}
 */
export async function deleteIssueLink(projectId, issueIid, issueLinkId) {
    const url = new URL(`${GITLAB_API_URL}/projects/${encodeURIComponent(projectId)}/issues/${issueIid}/links/${issueLinkId}`);
    try {
        const response = await axios.delete(url.toString(), {
            headers: DEFAULT_HEADERS,
 ...
 */
export async function listLabels(projectId, options = {}) {
 ...
 */
export async function getLabel(projectId, labelId, includeAncestorGroups) {
 ...
 */
export async function createLabel(projectId, options) {
    // Make the API request
    const response = await axios.post(`${GITLAB_API_URL}/projects/${encodeURIComponent(projectId)}/labels`, options, {
        headers: DEFAULT_HEADERS,
    });
    // Handle errors
    await handleGitLabError(response);
 ...
 */
export async function updateLabel(projectId, labelId, options) {
    // Make the API request
    const response = await axios.put(`${GITLAB_API_URL}/projects/${encodeURIComponent(projectId)}/labels/${encodeURIComponent(String(labelId))}`, options, {
        headers: DEFAULT_HEADERS,
    });
    // Handle errors
    await handleGitLabError(response);
...
export async function deleteLabel(projectId, labelId) {
    // Make the API request
    const response = await axios.delete(`${GITLAB_API_URL}/projects/${encodeURIComponent(projectId)}/labels/${encodeURIComponent(String(labelId))}`, {
        headers: DEFAULT_HEADERS,
    });
    // Handle errors
    await handleGitLabError(response);
 ...
 */
export async function createMergeRequest(projectId, options) {
 ...
 */
export async function listMergeRequestDiscussions(projectId, mergeRequestIid) {
 ...
 */
export async function updateMergeRequestNote(projectId, mergeRequestIid, discussionId, noteId, body, resolved) {
 ...
 */
export async function createOrUpdateFile(projectId, filePath, content, commitMessage, branch, previousPath, last_commit_id, commit_id) {
    const encodedPath = encodeURIComponent(filePath);
    const url = new URL(`${GITLAB_API_URL}/projects/${encodeURIComponent(projectId)}/repository/files/${encodedPath}`);
    const body = {
        branch,
 ...
 */
export async function createCommit(projectId, message, branch, actions) {
...
export async function createRepository(options) {
    try {
        const response = await axios.post(`${GITLAB_API_URL}/projects`, {
            name: options.name,
            description: options.description,
 ...
 */
export async function searchProjects(query, page = 1, perPage = 20) {
 ...
 */
export async function createTree(projectId, files, ref) {
 ...
 */
export async function forkProject(projectId, namespace) {
    // API URL
...
export async function listProjects(options = {}) {
    ...
    // Make the API request
    const response = await axios.get(`${GITLAB_API_URL}/projects?${params.toString()}`, {
        headers: DEFAULT_HEADERS,
    });
    // Handle errors
    await handleGitLabError(response);
 ...
 */
export async function listGroupProjects(options) {
 ...
 */
export async function getMergeRequest(projectId, mergeRequestIId) {
 ...
 */
export async function getMergeRequestDiffs(projectId, mergeRequestIid, view) {
 ...
 */
export async function updateMergeRequest(projectId, mergeRequestIid, options) {
    const url = new URL(`${GITLAB_API_URL}/projects/${encodeURIComponent(projectId)}/merge_requests/${mergeRequestIid}`);
    try {
 ...
 */
export async function createNote(projectId, noteableType, // 'issue' 또는 'merge_request' 타입 명시
noteableIid, body) {
    const url = new URL(`${GITLAB_API_URL}/projects/${encodeURIComponent(projectId)}/${noteableType}s/${noteableIid}/notes`);
 ...
 */
export async function getNamespace(id) {
 ...
 */
export async function verifyNamespaceExistence(namespacePath, parentId) {
    ...
    try {
        ...
        switch (request.params.name) {
            case 'fork_repository': {
                ...
                try {
                    const forkedProject = await forkProject(args.project_id, args.namespace);
                    return {
                        content: [
            ...
            case 'add_merge_request_diff_comment': {
                ...
                const discussion = await api.MergeRequestDiscussions.create(args.project_id, args.merge_request_iid, args.comment, {
                    position: {
            ...
            case 'update_merge_request_note': {
                ...
                const note = await updateMergeRequestNote(args.project_id, args.merge_request_iid, args.discussion_id, args.note_id, args.body, args.resolved);
                return {
